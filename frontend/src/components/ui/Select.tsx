		...
		>
			<div className="relative">
				<ComboboxInput
					...
					className={clsx(
						"w-full rounded-box border-none bg-zinc-900 py-1.5 pr-8 pl-3 text-sm/6 text-white",
			...
			<ComboboxOptions
				anchor="bottom"
				className={clsx(
					"w-[var(--input-width)] rounded-box border border-white/5 bg-zinc-900 p-1 [--anchor-gap:var(--spacing-1)] empty:invisible",
			...
			>
				{filteredOptions.map((option, idx) => (
					<ComboboxOption
						key={idx}
						value={option}
						className="group flex cursor-pointer items-center gap-2 rounded-box px-3 py-1.5 select-none data-focus:bg-white/10"
					>
