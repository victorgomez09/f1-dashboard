	...
	return (
		<div>
			...
			<div className="my-4 flex flex-col">
				<div className="flex gap-1">
					<p className="flex items-center gap-1">
						<span className="size-4 rounded-box bg-white" /> White
					</p>
					<p>Last lap time</p>
				</div>
				...
				<div className="flex gap-1">
					<p className="flex items-center gap-1 text-yellow-500">
						<span className="size-4 rounded-box bg-amber-400" /> Yellow
					</p>
				...
				<div className="flex gap-1">
					<p className="flex items-center gap-1 text-emerald-500">
						<span className="size-4 rounded-box bg-emerald-500" /> Green
					</p>
					<p>Personal best</p>
				</div>
				...
				<div className="flex gap-1">
					<p className="flex items-center gap-1 text-violet-500">
						<span className="size-4 rounded-box bg-violet-500" /> Purple
					</p>
					<p>Overall best</p>
				</div>
				...
				<div className="flex gap-1">
					<p className="flex items-center gap-1 text-blue-500">
						<span className="size-4 rounded-box bg-blue-500" /> Blue
					</p>
			...
			<div className="grid grid-cols-1 gap-x-4 divide-y divide-zinc-800 sm:grid-cols-3 sm:divide-y-0">
				<div>
					<p className="rounded-box bg-violet-800/30 p-2">Driver has a purple background</p>
					<p className="p-2">Driver has the fastest overall lap time</p>
				</div>

				<div className="pt-4 sm:pt-0">
					<p className="rounded-box border p-2 opacity-50">Driver is a bit transparent</p>
					<p className="p-2">Driver has crashed or retired from the session</p>
				</div>

				<div className="pt-4 sm:pt-0">
					<p className="rounded-box bg-red-800/30 p-2">Driver has a red background</p>
