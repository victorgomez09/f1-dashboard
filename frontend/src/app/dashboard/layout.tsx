	...
	return (
		<div className="flex h-screen w-full p-2">
			...
			<motion.div layout="size" className="flex h-full w-full flex-1 flex-col md:gap-2">
				...
				<div
					className={
						!syncing || ended ? 'no-scrollbar w-full flex-1 overflow-auto md:rounded-box' : 'hidden'
					}
				>
					<MobileDynamicBar />
					{children}
				...
				<div
					className={
						syncing && !ended
							? 'flex h-full flex-1 flex-col items-center justify-center gap-2 md:rounded-box md:border'
							: 'hidden'
					}
				>
	...
	return (
		<div className="card bg-base-300 w-full">
			<div className="card-body p-2">
				<div className="hidden md:flex flex-row justify-between overflow-hidden w-full">
					<div className="flex items-center gap-2">
						<AnimatePresence>
