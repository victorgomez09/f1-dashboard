	...
	return (
		<div className="relative h-full w-full">
			...
			{!loading && frames.length > 0 && (
				<div className="absolute right-0 bottom-0 left-0 z-20 m-2 flex gap-4 rounded-box bg-black/80 p-4 backdrop-blur-xs md:right-auto md:w-lg">
			...
			{loading && <div className="h-full w-full animate-pulse rounded-box bg-zinc-800" />}
		</div>
	);
}
