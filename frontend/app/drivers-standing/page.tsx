...
import { useDriverStats } from "@/hooks/use-drivers";
import { useTeams } from "@/hooks/use-teams";

export default function DriverStandingPage() {
    const { driverStanding, driverRanking, driverStats, driverPointsDistribution, isLoading: driversLoading } = useDriverStats(2025)
